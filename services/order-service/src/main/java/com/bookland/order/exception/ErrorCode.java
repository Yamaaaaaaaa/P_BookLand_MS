...
public enum ErrorCode {
    ...
    // Bill
    BILL_NOT_FOUND(5050, "Không tìm thấy đơn hàng", HttpStatus.NOT_FOUND),
    INVALID_STATUS_TRANSITION(5051, "Chuyển đổi trạng thái đơn hàng không hợp lệ", HttpStatus.BAD_REQUEST),
